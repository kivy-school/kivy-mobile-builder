...
Vendored from kivy-school/ksproject (src/ksproject_utils/gradle/cpython_android.py)
so the libpython workflow builds from this repo instead of cloning ksproject.
"""
...
# Platform tag of the published wheels; see DEFAULT_ANDROID_API in
# build_python_target.py for why this is 24 and not 21.
